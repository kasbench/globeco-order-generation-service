...
class Settings(BaseSettings):
    ...
    external_service_timeout: int = Field(
        default=10,
        description="External service request timeout in seconds"
    )
    ...
    optimization_timeout: int = Field(
        default=30,
        description="Optimization solver timeout in seconds"
    )
    max_parallel_rebalances: int = Field(
        default=10,
        description="Maximum number of parallel rebalancing operations"
    )
